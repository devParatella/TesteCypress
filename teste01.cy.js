...
context("Controles RPVFinance", () => {
    ...
    it("cadastrar entradas", () => {
      ...
      cy.get("#data-table tbody tr").should(($tr) => {
        ...
        expect(cells.eq(1)).to.contain.text("R$ 2.500,00");
        expect(cells.eq(2)).to.contain.text("22/07/2023");
      });
  
      // Verificar se os valores foram atualizados corretamente no balanço
      cy.get("#incomeDisplay").should("contain.text", "R$ 2.500,00");
      cy.get("#totalDisplay").should("contain.text", "R$ 2.500,00");
    });
    ...
    it("cadastrar saídas", () => {
      ...
      // Verificar se os valores foram atualizados corretamente no balanço
      cy.get("#expenseDisplay").should("contain.text", "R$ 500,00");
    ...
    it("remover lançamento", () => {
      ...
      // Verificar se os valores foram atualizados corretamente no balanço
      cy.get("#incomeDisplay").should("contain.text", "R$ 0,00");
      cy.get("#totalDisplay").should("contain.text", "R$ 0,00");
    });
  });